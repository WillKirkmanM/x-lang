// Demonstrates the 'become' keyword for guaranteed tail-call optimisation (TCO).
...
pure fn sum_helper(n: f64, accumulator: f64) -> f64 {
    if (n == 0.0) {
        ...
        become sum_helper(n - 1.0, n + accumulator);
    }
}
